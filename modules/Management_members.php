...
<?php include('add_membre.php'); ?>
                  ...
                  <td style="text-align:center; word-break:break-all; width:300px;"> <?php echo $row ['email']; ?></td>s
                  ...
                  <td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['city_dest']; ?></td>
  								...
  								<p><div style="font-size:larger;" class="alert alert-danger">Are you Sure you want Delete <b style="color:red;"><?php echo $row['first_name']." ".$row['last_name']." ".$row['pseudo']." ".$row['country_origin']." ".$row['city_origin']." ".$row['fb_name']." ".$row['email']." ".$row['password']." ".$row['country_dest']." ".$row['city_dest']; ?></b> Data?</p>
  								</div>
  								<hr>
