...
<div class="row">
    ...
    <form class="col s12" action="../functions/f_user.php" method="post">
      <div class="row">
        <div class="input-field col s6">
          <input id="first_name" required name="first_name" type="text" class="validate" required >
        ...
        <div class="input-field col s12">
          <input value="firstname.lastname" id="pseudo" type="text" class="validate" name="pseudo" required>
          <label class="active" for="pseudo" name="pseudo">Pseudo</label> <!--sa fac un trigger ceva, in caz ca nu respecta asta -->
        </div>
        <div class="input-field col s12">
          <input id="country_origin" type="text" class="validate" name="country_origin" required>
          <label for="country_origin" name="country_origin">Country of origin</label>
        </div>
        <div class="input-field col s12">
          <input id="city_origin" type="text" class="validate" name="city_origin" required>
          <label for="city_origin" name="city_origin">City of origin</label>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s12">
          <input id="fb_name" type="text" class="validate" name="fb_name" required>
  ...
  <div class="row">
    <div class="input-field col s12">
      <input id="country_dest" value="only if you are already an erasmus" type="text" class="validate" name="country_dest">
      <label  for="country_dest" id="show-option" name="country_dest" > Country of destination </label>
    </div>
  </div>
  <div class="row">
    <div class="input-field col s12">
      <input id="city_dest" value="only if you are already an erasmus" type="text" class="validate" name="city_dest">
